...
//    private SelectedMediaAdapter mSelectedVideoAdapter;
    ...
    private MediaInfo returnMediaInfo;
...
//        mBtnNextStep = (Button) findViewById(R.id.btn_next_step);
        ...
        storage.setOnCurrentMediaInfoChangeListener(new MediaStorage.OnCurrentMediaInfoChange() {
            ...
            public void onCurrentMediaInfoChanged(MediaInfo info) {
                ...
                Intent intent = new Intent(MediaActivity.this,act);
                intent.putExtra("vpath",returnMediaInfo.filePath);
                intent.putExtra("vthum", returnMediaInfo.thumbnailPath);
                intent.putExtra("videoDuration",(long) returnMediaInfo.duration);
...
//        mRvSelectedVideo.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        String len = convertDuration2Text(0);
//        mTvTotalDuration.setText(len);
...
//            intent.putExtra("vpath",returnMediaInfo.filePath);
//            intent.putExtra("vthum", returnMediaInfo.thumbnailPath);
//            intent.putExtra("videoDuration",returnMediaInfo.duration);
//            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//            startActivity(intent);
//            onBackPressed();
//        }
