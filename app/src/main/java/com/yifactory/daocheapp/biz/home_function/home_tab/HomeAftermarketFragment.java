...
public class HomeAftermarketFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static HomeAftermarketFragment newInstance() {
        HomeAftermarketFragment fragment = new HomeAftermarketFragment();
                ...
                if (dataBean != null) {
                    ...
                    if (bannersBeanList != null && bannersBeanList.size() > 0) {
                        ...
                        for (GetSystemInfoBean.DataBean.BannersBean bannersBean : bannersBeanList) {
                            if (bannersBean.getBannerLeval() == 7) {
    ...
    private void getOneVideoList(final String requestMark, int pageNum) {
        ...
        String fcId = mEightModuleFcIdSp.getEightModuleFcId("后市场");
        RxHttpUtils.createApi(ApiService.class)
