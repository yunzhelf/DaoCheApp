...
public class HomeCarSupermarketFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static HomeCarSupermarketFragment newInstance() {
        HomeCarSupermarketFragment fragment = new HomeCarSupermarketFragment();
                ...
                if (dataBean != null) {
                    ...
                    if (bannersBeanList != null && bannersBeanList.size() > 0) {
                        ...
                        for (GetSystemInfoBean.DataBean.BannersBean bannersBean : bannersBeanList) {
                            if (bannersBean.getBannerLeval() == 5) {
    ...
    private void getOneVideoList(final String requestMark, int pageNum) {
        ...
        String fcId = mEightModuleFcIdSp.getEightModuleFcId("汽车超市");
        RxHttpUtils.createApi(ApiService.class)
