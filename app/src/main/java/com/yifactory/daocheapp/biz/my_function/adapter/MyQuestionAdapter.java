...
public class MyQuestionAdapter extends BaseQuickAdapter<DiscoverBean, BaseViewHolder> {

    private RecyclerVScrollEventCallBack scrollEventCallBack;

    public MyQuestionAdapter(int layoutResId, RecyclerVScrollEventCallBack scrollEventCallBack) {
        super(layoutResId);
