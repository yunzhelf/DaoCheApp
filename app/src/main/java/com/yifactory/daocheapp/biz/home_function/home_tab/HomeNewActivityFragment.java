...
public class HomeNewActivityFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static HomeNewActivityFragment newInstance() {
        HomeNewActivityFragment fragment = new HomeNewActivityFragment();
                ...
                if (dataBean != null) {
                    ...
                    if (bannersBeanList != null && bannersBeanList.size() > 0) {
                        ...
                        for (GetSystemInfoBean.DataBean.BannersBean bannersBean : bannersBeanList) {
                            if (bannersBean.getBannerLeval() == 6) {
    ...
    private void getOneVideoList(final String requestMark, int pageNum) {
        ...
        String fcId = mEightModuleFcIdSp.getEightModuleFcId("新能源");
        RxHttpUtils.createApi(ApiService.class)
