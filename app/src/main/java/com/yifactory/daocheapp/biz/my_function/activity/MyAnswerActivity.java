...
import com.yifactory.daocheapp.biz.my_function.adapter.MyAnswerAdapter;
...
public class MyAnswerActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, MyAnswerAdapter.RecyclerVScrollEventCallBack {
        ...
        mRv_answers.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    Glide.with(MyAnswerActivity.this).resumeRequests();
                } else {
                    Glide.with(MyAnswerActivity.this).pauseRequests();
                }
            }
        });
    }
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        mDialog.show();
        getUserAnswersListData(ApiConstant.REQUEST_NORMAL, mCurPageNum);
    }

    private void getUserAnswersListData(final String requestMark, int pageNum) {
        RxHttpUtils
                .createApi(ApiService.class)
                .getUserAnswersList(mUId, pageNum)
    ...
    public void onRefresh() {
        mCurPageNum = 0;
        getUserAnswersListData(ApiConstant.REQUEST_REFRESH, mCurPageNum);
    }
