...
public class HomeRecommendHeadLineDetailActivity extends BaseActivity {
    @BindView(R.id.head_detail_wv)
    WebView webView;
    GetSystemInfoBean.DataBean.SysIndexNewsBean newBean;
    TitleBar titleBar;
    @Override
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        newBean = (GetSystemInfoBean.DataBean.SysIndexNewsBean) getIntent().getSerializableExtra("new");
    }

    @Override
    protected void initView() {
        if(newBean.getType() == 3 && newBean.getTId() != null){
            webView.loadUrl(newBean.getTId());
        }
...
//            progressBar.setVisibility(View.VISIBLE);
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if(url.equals("http://www.google.com/")){
                Toast.makeText(HomeRecommendHeadLineDetailActivity.this,"国内不能访问google,拦截该url",Toast.LENGTH_LONG).show();
