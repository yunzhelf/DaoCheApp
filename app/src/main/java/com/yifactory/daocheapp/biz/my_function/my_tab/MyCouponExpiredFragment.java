...
public class MyCouponExpiredFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static MyCouponExpiredFragment newInstance() {
        MyCouponExpiredFragment fragment = new MyCouponExpiredFragment();
    ...
    private void getExpiredCouponList(){
