...
public class HomeInterviewFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static HomeInterviewFragment newInstance() {
        HomeInterviewFragment fragment = new HomeInterviewFragment();
                ...
                if (dataBean != null) {
                    ...
                    if (bannersBeanList != null && bannersBeanList.size() > 0) {
                        ...
                        for (GetSystemInfoBean.DataBean.BannersBean bannersBean : bannersBeanList) {
                            if (bannersBean.getBannerLeval() == 2) {
    ...
    private void getOneVideoList(final String requestMark, int pageNum) {
        ...
        String fcId = mEightModuleFcIdSp.getEightModuleFcId("人物专访");
        RxHttpUtils.createApi(ApiService.class)
