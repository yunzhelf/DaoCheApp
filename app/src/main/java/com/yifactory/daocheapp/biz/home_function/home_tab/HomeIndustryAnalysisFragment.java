...
public class HomeIndustryAnalysisFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static HomeIndustryAnalysisFragment newInstance() {
        HomeIndustryAnalysisFragment fragment = new HomeIndustryAnalysisFragment();
                ...
                if (dataBean != null) {
                    ...
                    if (bannersBeanList != null && bannersBeanList.size() > 0) {
                        ...
                        for (GetSystemInfoBean.DataBean.BannersBean bannersBean : bannersBeanList) {
                            if (bannersBean.getBannerLeval() == 3) {
    ...
    private void getOneVideoList(final String requestMark, int pageNum) {
        ...
        String fcId = mEightModuleFcIdSp.getEightModuleFcId("行业分析");
        RxHttpUtils.createApi(ApiService.class)
