...
import com.yifactory.daocheapp.utils.DensityUtil;
...
public class BaseSwipeRefreshLayout extends SwipeRefreshLayout {
    ...
    private void init() {
        setProgressViewOffset(false, DensityUtil.dip2px(getContext(), -50), DensityUtil.dip2px(getContext(), 30));
        setColorSchemeColors(getContext().getResources().getColor(R.color.theme_color));
    }
